...
| $$\  $$$| $$  | $$| $$  | $$| $$  \ $$        | $$  \ $$| $$  | $$    | $$    
| $$ \  $$|  $$$$$$/|  $$$$$$/| $$$$$$$/        | $$$$$$$/|  $$$$$$/    | $$    
|__/  \__/ \______/  \______/ |_______/         |_______/  \______/     |__/ 
''')
def slowprint(s):
    for c in s + '\n' :
        sys.stdout.write(c)
...
slowprint(" \033[95m[!] Learn Technology  On my Channel ")
...
`MM'    `MM'                 `MM            dM.          `MM                68b           
 MM      MM                   MM           ,MMb           MM                Y89           
 MM      MM    ___     ____   MM   __      d'YM.      ____MM ___  __    __  ___ ___  __   
 MM      MM  6MMMMb   6MMMMb. MM   d'     ,P `Mb     6MMMMMM `MM 6MMb  6MMb `MM `MM 6MMb  
 MMMMMMMMMM 8M'  `Mb 6M'   Mb MM  d'      d'  YM.   6M'  `MM  MM69 `MM69 `Mb MM  MMM9 `Mb 
 MM      MM     ,oMM MM    `' MM d'      ,P   `Mb   MM    MM  MM'   MM'   MM MM  MM'   MM 
 MM      MM ,6MM9'MM MM       MMdM.      d'    YM.  MM    MM  MM    MM    MM MM  MM    MM 
 MM      MM MM'   MM MM       MMPYM.    ,MMMMMMMMb  MM    MM  MM    MM    MM MM  MM    MM 
 MM      MM MM.  ,MM YM.   d9 MM  YM.   d'      YM. YM.  ,MM  MM    MM    MM MM  MM    MM 
_MM_    _MM_`YMMM9'Yb.YMMMM9 _MM_  YM._dM_     _dMM_ YMMMMMM__MM_  _MM_  _MM_MM__MM_  _MM_''')
print(''' \033[93m
+----------------------------------------------+
|     Best Tool For find Admin Login Page     |
+----------------------------------------------+''')
slowprint('''\033[93m| coded by : NOOB-BOY                        |
| Date : 29/11/2021                            |                        |
| YouTube : HINDI TECH                         |
| Instagram : ba_db_oy1  && Bca_sayar                                               |
| Version : v1.1                               |
| This program is made only for Penetration Testing |''')
print('''\033[93m+----------------------------------------------+
''')
slowprint("\033[95mYou Have to Enter Website With http:// or https://  ")
slowprint("\033[95mAdd / At The End of Website Like https://hinditech.tech/ ")
print("                                                                ")

url = input("\033[96m # Enter a Website : ")

print ("\033[95m # searching loophole : ")
print("                                                                                        ")
